...
namespace IntroSE.Kanban.Backend.ServiceLayer
{
    ...
    /// </para>
    /// </summary>
    public class M1_GradingService
    {
        public UserService UserService { get; }
        public BoardService BoardService { get; }
        public TaskService TaskService { get; }

        public M1_GradingService()
        {
        ...
        /// <returns>The string "{}", unless an error occurs (see <see cref="M1_GradingService"/>)</returns>
        ...
        /// <returns>Response with user email, unless an error occurs (see <see cref="M1_GradingService"/>)</returns>
        ...
        /// <param name="boardName">The name of the board</param>
        /// <param name="columnOrdinal">The column ID. The first column is identified by 0, the ID increases by 1 for each column</param>
        /// <returns>Response with column limit value, unless an error occurs (see <see cref="M1_GradingService"/>)</returns>
        ...
        /// <param name="boardName">The name of the board</param>
        /// <param name="columnOrdinal">The column ID. The first column is identified by 0, the ID increases by 1 for each column</param>
        /// <returns>Response with column name value, unless an error occurs (see <see cref="M1_GradingService"/>)</returns>
        ...
        /// <param name="boardName">The name of the board</param>
        /// <param name="columnOrdinal">The column ID. The first column is identified by 0, the ID increases by 1 for each column</param>
        /// <returns>Response with  a list of the column's tasks, unless an error occurs (see <see cref="M1_GradingService"/>)</returns>
        ...
        /// </summary>
        /// <param name="email">Email of the user. Must be logged in</param>
        /// <returns>Response with  a list of the in progress tasks, unless an error occurs (see <see cref="M1_GradingService"/>)</returns>
